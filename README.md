...
>  
> [<img alt="Downloads" src="https://img.shields.io/github/downloads/BlueWitherer/QuickGameplayActions/total?style=for-the-badge&logo=geode&logoColor=ffffff&label=Downloads">](https://www.geode-sdk.org/mods/cheeseworks.quickgameplayactions)
...
### Menu
A menu will appear in-game, tt'll have your essentials such as practice mode and restart level. Since the intention is for the player to do stuff quicker, these buttons will have no confirmation pop-up and will immediately function as intended.
